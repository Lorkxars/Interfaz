 ...
 * @author david
 */
public class Accesibilidad extends javax.swing.JFrame {

    /**
     * Creates new form Accesibilidad
     */
    ...
    private void initComponents() {
        ...
        jButton1.setText("Activar lector de texto");
        ...
        jButton2.setText("Activar modo para Daltonicos");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Accesibilidad.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Accesibilidad().setVisible(true);
            }
        });
    }
